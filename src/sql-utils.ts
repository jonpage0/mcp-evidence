 ...
 */
export function extractColumnsFromSelectStarCte(query: string): string[] | null {
  try {
 ...
 */
export function extractColumnNames(query: string): string[] | null {
  try {
 ...
 */
export function addExplicitColumnAliases(query: string): string {
