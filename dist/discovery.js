...
export class EvidenceDataDiscovery {
     ...
     */
    _parseManifest(manifestData, dataPath) {
        const sources = {};
        ...
        if (manifestData.renderedFiles && typeof manifestData.renderedFiles === 'object') {
            ...
            const renderedFiles = manifestData.renderedFiles;
     ...
     * @param dataPath The base data path.
     */
    _discoverSourcesFromDirectories(dataPath) {
        const sources = {};
        try {
